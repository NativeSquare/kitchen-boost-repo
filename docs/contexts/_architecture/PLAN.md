...
|                             |                                                                                                                                     |
| --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| **Étape workflow**          | Phase 1 — Session active ([WORKFLOW.md](WORKFLOW.md)) : boucle `/grill-with-docs` → `/to-prd` → `/to-issues`, chantier par chantier |
| **Chantier en cours**       | **1.x Foundation** — backlog complet (epic #1 + 7 stories #2–#8), prêt pour le dev AFK                                              |
| **Chantiers de PRD écrits** | 1 / ~36                                                                                                                             |
| **Issues publiées**         | epic [#1](https://github.com/NativeSquare/kitchen-boost-repo/issues/1) + 7 stories (#2–#8)                                          |
| **Code mergé**              | 0 (aucun code en Phase 1 — on remplit le backlog)                                                                                   |
...
| ----- | ----------------------------------------------------------------------- | --------------------------------------------------------------------------- | ---------- | ---- | ------ |
| 1     | **2.1 Customer Data** (anonymous auth, sessions, consent, cgv_versions) | [90](../../prd/90_donnees_clients_crm.md) + ADR 0008                        | 1.x        | #—   | ⛔     |
