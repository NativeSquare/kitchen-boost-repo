...
| Setup workflow AFK (skills `/work-next-agent-issue` + `/work-all-agent-issues`, CI `check.yml`, ESLint `no-untenanted-query`, Husky, `convex-test`) | WORKFLOW §8 | ⛔ | **Session dédiée**, avant la 1ʳᵉ nuit de dev |
