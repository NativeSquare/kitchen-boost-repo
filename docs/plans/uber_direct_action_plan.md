...
| #     | Tâche                                                                                         | Owner      | Statut |
| ----- | --------------------------------------------------------------------------------------------- | ---------- | ------ |
| C.3.1 | Configurer custom domain `buns-bao.kitchen-boost.com` sur Vercel                              | Dev        | ⬜     |
...
| #     | Tâche                                                                                   | Owner | Statut |
| ----- | --------------------------------------------------------------------------------------- | ----- | ------ |
| C.4.1 | Designer sticker QR (vinyle laminé mat, 50mm rond, URL `buns-bao.kitchen-boost.com/r/`) | Alex  | ⬜     |
