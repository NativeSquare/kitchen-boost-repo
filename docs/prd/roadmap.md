...
| Provisioning d'un tenant (script CLI minimum + UI `KitchenBoost Admin` basique) | [50](50_multi_tenant_saas.md) + [70](70_kb_admin.md) | Crée row DB + sous-domaine `<slug>.kitchen-boost.com` + lien Stripe Connect + user `kb_manager` + ligne `user_tenants` |
