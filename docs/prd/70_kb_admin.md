...
Une seule codebase, une seule URL, une seule auth. Le RBAC scope les composants, les routes API et la DB (RLS Postgres).
...
- Source des cmds (direct + Uber Eats + Deliveroo via Hubrise dès V1)
