...
5. **Deux espaces d'URL distincts**, par contrat backend :
   - `/tenants` + `/tenants/[id]` = **supervision**, KB Admin uniquement, fonctions `kbAdminQuery` (statuts intégrations, milestones pipeline, contrats, embed KYC, monitoring).
